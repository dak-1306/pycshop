...
const DashboardInsights = ({ data = {} }) => {
  ...
  const insights = useMemo(
    ...
    [topPerformingCategory, peakTrafficTime, revenueGrowth, newUsersToday]
  );
...
DashboardInsights.propTypes = {
  data: PropTypes.shape({
    ...
    peakTrafficTime: PropTypes.string,
    revenueGrowth: PropTypes.number,
    newUsersToday: PropTypes.number,
  }),
};

export default React.memo(DashboardInsights);
