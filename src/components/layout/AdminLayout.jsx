...
const AdminLayout = () => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      href: "/admin/users",
      icon: (
        <FontAwesomeIcon icon={["fas", "users"]} className="w-5 h-5" />
      ),
    },
    {
      name: t("products"),
    ...
    },
    {
      ...
      href: "/admin/sellers",
      icon: (
        <FontAwesomeIcon icon={["fas", "store"]} className="w-5 h-5" />
      ),
    },
    {
      name: t("reports"),
    ...
    },
    {
      ...
      href: "/admin/settings",
      icon: (
        <FontAwesomeIcon icon={["fas", "cogs"]} className="w-5 h-5" />
      ),
    },
      ...
      ? [
          {
            ...
            icon: (
              <FontAwesomeIcon icon={["fas", "user-shield"]} className="w-5 h-5" />
            ),
          },
        ]
      : []),
