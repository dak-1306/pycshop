              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="text-xs text-orange-600 hover:text-orange-700 font-medium opacity-0 group-hover:opacity-100 transition-opacity hover:bg-orange-50 px-2 py-1 rounded ml-2 flex-shrink-0"
                  >
                    Xem chi tiết
                  </button>
                </div>
