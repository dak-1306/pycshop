...
const translations = {
  vi: {
    ...
    seller: 'Người bán',
    price: 'Giá',
    stock: 'Tồn kho',    quantity: 'Số lượng',
    productList: 'Danh sách sản phẩm',
    
    // Reports
    reportsAnalytics: 'Báo cáo & Thống kê',
    systemOverview: 'Tổng quan và phân tích chi tiết hoạt động hệ thống PycShop',
    loadingReports: 'Đang tải dữ liệu báo cáo...',
    exportReport: 'Xuất báo cáo',
    refreshData: 'Làm mới',
    exportSuccess: 'Đã xuất báo cáo thành công!',    selectDateRange: 'Chọn khoảng thời gian',
    ...
    // Recent Reports
    recentReports: 'Báo cáo vi phạm gần đây',
    recentReportsDescription: 'Quản lý và xử lý các báo cáo vi phạm từ người dùng',
    ...
    confirmApprove: 'Bạn có chắc chắn muốn phê duyệt báo cáo này?',    confirmReject: 'Bạn có chắc chắn muốn từ chối báo cáo này?',
    ...
    systemOverview: 'Comprehensive overview and detailed analysis of PycShop system activities',
    loadingReports: 'Loading report data...',
    exportReport: 'Export Report',
    refreshData: 'Refresh',
    exportSuccess: 'Report exported successfully!',    selectDateRange: 'Select Date Range',
    
    // Recent Reports
    recentReports: 'Recent Violation Reports',
    recentReportsDescription: 'Manage and process violation reports from users',
    ...
    confirmApprove: 'Are you sure you want to approve this report?',    confirmReject: 'Are you sure you want to reject this report?',
    noteRequired: 'Please enter a note',
    noReportsMessage: 'All reports have been processed or no new reports available',
    showing: 'Showing',
    of: 'of',
