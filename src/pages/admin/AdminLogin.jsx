...
const AdminLogin = () => {
  ...
  useEffect(() => {
    ...
    if (urlParams.get("reason") === "no_permission") {
      setError(
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-300">
            Đăng nhập vào hệ thống quản trị PycShop
          </p>
        </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-xs text-blue-300">
                    <p>• Sử dụng tài khoản admin đã tạo trong database</p>
                    <p>
                      • Hoặc dùng endpoint /auth/register-admin để tạo admin mới
                    </p>
                    <p>
                      <strong>Demo:</strong> admin@pycshop.com / admin123
                    </p>
                  </div>
                  <button
                    type="button"
