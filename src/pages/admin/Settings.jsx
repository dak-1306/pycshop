...
const AdminSettings = () => {
  ...
  const { language, changeLanguage, t, isVietnamese, isEnglish } = useLanguage();
      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-6 border border-blue-200 dark:border-gray-600">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
            <div className="flex items-center">
              <span className="text-gray-600 dark:text-gray-300 mr-2">Giao diện:</span>
              <span className="font-semibold text-gray-900 dark:text-white">
                {theme === 'light' ? '🌞 Sáng' : '🌙 Tối'}
              </span>
            </div>
            <div className="flex items-center">
              <span className="text-gray-600 dark:text-gray-300 mr-2">Ngôn ngữ:</span>
              <span className="font-semibold text-gray-900 dark:text-white">
